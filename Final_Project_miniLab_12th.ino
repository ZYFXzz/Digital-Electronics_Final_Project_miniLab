...
StevesAwesomeRotaryEncoder rotaryEncoderMaster(14, 15, 0);
StevesAwesomeRotaryEncoder rotaryEncoder1(34, 35, 1);
StevesAwesomeRotaryEncoder rotaryEncoder2(31, 30, 2);
StevesAwesomeRotaryEncoder rotaryEncoder3(25, 24, 3);
StevesAwesomeRotaryEncoder rotaryEncoder4(28, 27, 4);
...
StevesAwesomeButton encoderButtonMaster(13, 0, INPUT_PULLUP);  //encoder 0
StevesAwesomeButton encoderButton1(33, 1, INPUT_PULLUP);
StevesAwesomeButton encoderButton2(32, 2, INPUT_PULLUP);
StevesAwesomeButton encoderButton3(26, 3, INPUT_PULLUP);
StevesAwesomeButton encoderButton4(29, 4, INPUT_PULLUP);
...
void onStepCheckPotPushed() {
  for (int i = 0; i < 4; i++) {
    lastPotVals[i] = potVals[i];
    // if(){      // if pot pushed, print pot reading

    // }
    // displayReading(1,i,0,0,0);  // hard to print display reading value without sufficient knowledge, leave it for now
    // displayReading(byte mode, byte potNum, byte encoderDirection, int encoderValue, int noteName)
